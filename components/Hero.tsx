      ...
      <div className="container relative z-10 mx-auto px-6 py-12 md:py-20">
        ...
        >
          <div className="w-full max-w-5xl">
            <motion.div variants={fadeInUp} className="mb-8 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50/50 backdrop-blur-sm px-6 py-2 text-[10px] md:text-xs font-black text-blue-600 uppercase tracking-[0.3em]">
              <span className="flex h-2 w-2 rounded-full bg-blue-600 animate-pulse" />
              VK LOGISTICS SOLUTIONS - Industrial Logistics Experts
            </motion.div>
            
            <motion.h1 variants={fadeInUp} className="mb-8 text-6xl md:text-8xl lg:text-[10rem] font-black leading-[0.9] text-slate-900 tracking-tighter">
              PRECISION <br />
              <span className="text-blue-600">LOGISTICS.</span>
            </motion.h1>
            
            <motion.p variants={fadeInUp} className="mx-auto mb-12 max-w-3xl text-xl md:text-3xl font-medium text-slate-600 leading-relaxed italic">
              &quot;Expert supply chain management for Polymers, Tyres, Petrochemicals &amp; Home Appliances.&quot;
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="mt-20 flex flex-wrap items-center justify-center gap-10">
              {[
